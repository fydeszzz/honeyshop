...
export const ACHIEVEMENTS=[
  ...
  {id:"earn_500",   icon:"💰",name:"Honey Hoarder",   desc:"Accumulate 500 Honeypot",            reward:{type:"honeypot",amount:200},        cond:s=>s.totalEarned>=500},
  ...
  {id:"streak_3",   icon:"🔥",name:"On a Roll",       desc:"Log food 3 days in a row",           reward:{type:"bagel",amount:1},             cond:s=>s.streak>=3},
  {id:"streak_7",   icon:"🗓️",name:"Week Warrior",   desc:"Log food 7 days in a row",           reward:{type:"bagel",amount:3},             cond:s=>s.streak>=7},
  {id:"log_10",     icon:"📔",name:"Getting Serious", desc:"Log 10 entries total",               reward:{type:"honeypot",amount:100},        cond:s=>s.records.length>=10},
  ...
  {id:"first_bagel",icon:"🥯",name:"Bagel Baker",     desc:"Earn your first Bagel token",        reward:{type:"bagel",amount:1},             cond:s=>s.totalBagels>=1},
